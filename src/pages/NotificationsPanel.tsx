...
const notifications = [
  {
    id: '1',
    type: 'alert',
    title: 'High Congestion: Mess D',
    message: 'Mess D is currently at 95% capacity. Expect delays in the dining area.',
    time: '2 mins ago',
    icon: AlertTriangle,
    color: 'text-red-400',
    bg: 'bg-red-400/10',
  ...
  },
  {
    ...
    message: 'SMV Block, Room 302 is currently empty. Perfect for focused study.',
    time: '15 mins ago',
    icon: Info,
    color: 'text-blue-400',
    bg: 'bg-blue-400/10',
  ...
  },
  {
    ...
    message: 'New detour route via GDN Block is now 40% faster than the main corridor.',
    time: '1 hour ago',
    icon: Zap,
  ...
  },
  {
    ...
    message: 'Career Fair starting at Main Library. Expect high crowd density in the area.',
    time: '3 hours ago',
    icon: Users,
